...
\begin{figure*}[htbp]
    ...
    \caption{Residual errors and $R^2$ for all models and operators. 
        ...
        \EB{Esta figura precisa ser apresentada e referenciada no texto.}
...
\EB{Você apontou a principal conclusão, mas faltou apresentar o gráfico e comentar os resultados que divergem do normal, como o SVR para o gst3d}
