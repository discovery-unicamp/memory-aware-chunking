...
\begin{enumerate}
    \item Rank features using SelectKBest, which is a simple yet effective scikit-learn method~\cite{pedregosa2011scikit} that scores each feature according to a chosen statistical test and retains only the highest-scoring one.
