...
\EB{Faltou clarificar como isso levou a 768 execuções}

Each experiment varied the number of \dask workers from 1 to 8, with the available 32~GB of \ac{RAM} evenly distributed among workers (32~GB for 1 worker, 16~GB each for 2 workers, 8~GB each for 4 workers, and 4~GB each for 8 workers).
