...
That dataset can be downloaded from the Terranubis website~\cite{f3dataset}.
...
\EB{Daniel, algumas frases estão violando a margem da página. Após todas as correções e antes de gerar a versão final, seria bom corrigir estes problemas - sugiro fazer uma revisão visual do PDF.}
