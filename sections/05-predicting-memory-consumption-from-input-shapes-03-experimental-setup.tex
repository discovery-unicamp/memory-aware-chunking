...
The script looped over all permutations of \texttt{(inlines, xlines, samples)}, parsing \texttt{TraceQ} \EB{Lembrar de padronizar o termo \traceq} outputs and joining them with shape metadata.
...
\EB{Indicar um respositório de onde o leitor possa baixar este dado para reproduzir seu trabalho.}
...
The entire experiment is publicly available at a Github repository~\cite{delucca2025experiment2}.
...
A detailed \texttt{README.md} file describes environment requirements, including Docker, and explains how to run each step. \EB{Revisar o PDF para identificar violações de margem como esta do README.md.}
