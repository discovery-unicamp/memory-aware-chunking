\begin{resumo}
    ...
    Por meio \EBRP{de profiling de memória utilizando}{do perfilamento com}  a biblioteca \EBRP{original (TraceQ}{TraceQ, desenvolvida para este trabalho}, o uso de memória foi precisamente capturado em ambientes controlados e conteinerizados.
    ...
    Estudos de seleção de \EBC{features}{destacar palavras em inglês ou substituir por palavras em português} e redução de dados demonstraram que o volume total dos dados fornece capacidade preditiva suficiente, simplificando o processo.
    ...
    Em suma, esta dissertação introduz um método prático e automatizado que garante robustez em \EBRP{workflows}{fluxos de trabalho} Dask por meio do dimensionamento inteligente de partições.
...
\begin{abstract}
    ...
    This thesis presents an automated memory-aware chunking methodology that \EBRM{significantly} enhances the reliability of Dask-based applications by accurately predicting memory consumption from input data dimensions.
