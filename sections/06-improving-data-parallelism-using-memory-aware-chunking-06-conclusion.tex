...
\begin{itemize}
    ...
    Scaling from a single \ac{HPC} node to large clusters—or across heterogeneous hardware—may require considering network bandwidth, I/O patterns, and different memory topologies when predicting optimal chunk dimensions.
\end{itemize}
