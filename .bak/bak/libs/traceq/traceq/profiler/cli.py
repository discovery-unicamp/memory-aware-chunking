...
def attach_args(subparsers: _SubParsersAction) -> _SubParsersAction:
    ...
    profile_parser.add_argument(
        ...
        help="Define if the tracer should introspect to fetch function experiment and sign traces. This options adds a considerable overhead to the execution time (default: False)",
    )
