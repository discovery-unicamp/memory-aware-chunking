...
\begin{itemize}
    ...
    Complex regressors (\eg, gradient boosting or neural networks) provide only minor gains compared to simpler linear or polynomial regressions, making it practical for HPC teams to use faster-to-train models without losing accuracy.
\end{itemize}
