...
(1) different shapes that map to the same volume (e.g., $100$ $\times$ $300$ $\times$ $200$ vs. $300$ $\times$ $100$ $\times$ $200$) may exhibit distinct memory consumption, or
...
\begin{figure*}[htbp]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        ...
        \caption{Gaussian Filter}
    \end{subfigure}
    \caption{Memory safety margins comparing mean and 95\% percentile. Overheads in initial runs or shape-induced variability can inflate peak usage within the same volume bin.}
