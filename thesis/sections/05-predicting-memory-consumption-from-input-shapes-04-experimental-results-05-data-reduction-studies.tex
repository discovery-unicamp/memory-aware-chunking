...
\begin{figure}[htbp]
    ...
    \caption{Evolution of \ac{RMSE}, \ac{MAE}, $R^2$, and accuracy for the Envelope operator as sample size decreases. Performance remains stable down to ~30 samples.}
...
\begin{figure}[htbp]
    ...
    \caption{Evolution of \ac{RMSE}, \ac{MAE}, $R^2$, and accuracy for the Gaussian Filter as sample size decreases. Performance remains stable down to ~30 samples.}
...
\begin{figure}[htbp]
    ...
    \caption{Evolution of \ac{RMSE}, \ac{MAE}, $R^2$, and accuracy for \ac{GST3D} as sample size decreases. Performance remains stable down to ~30 samples.}
