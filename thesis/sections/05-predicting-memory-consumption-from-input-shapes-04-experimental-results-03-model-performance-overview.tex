...
Figures~\ref{fig:actual_vs_predicted_envelope}, \ref{fig:actual_vs_predicted_gst3d}, and \ref{fig:actual_vs_predicted_gaussian} confirm that these models closely align with actual memory values.
