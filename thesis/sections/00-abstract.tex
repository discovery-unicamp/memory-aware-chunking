\begin{resumo}
    ...
    \emph{Frameworks} paralelos em Python, como o Dask~\cite{rocklin2015dask}, utilizam estratégias automáticas de particionamento para dividir grandes volumes de dados em blocos menores.
    ...
    Por meio do perfilamento com a biblioteca \traceq, desenvolvida para este trabalho, o uso de memória foi precisamente capturado em ambientes controlados e conteinerizados.
...
\begin{abstract}
    ...
    Python-based data-parallel frameworks, such as Dask~\cite{rocklin2015dask}, employ automatic chunking strategies to divide large datasets into smaller blocks that fit into memory.
