...
Examples include seismic wave simulations on \ac{3D} grids~\cite{okamoto2010}, high-resolution image analysis in computer vision~\cite{yuyang2024}, and large-scale numerical linear algebra routines in scientific computing\ADDREF.
...
In the \ac{HPC} domain, historical job data from systems like Slurm often enable \ac{ML} models to predict resource consumption.
