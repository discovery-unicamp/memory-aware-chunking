...
Examples include seismic wave simulations on \ac{3D} grids\ADDREF, high-resolution image analysis in computer vision\ADDREF, and large-scale numerical linear algebra routines in scientific computing\ADDREF.
