...
Containerization practices like Docker and Singularity appear next, explaining how \ac{cgroup} enforces memory limits and how nested containers affect measurement strategies.
...
It compares studies that help users specify job memory requirements more accurately and overviews algorithms for optimizing memory usage in frameworks like Apache Spark.
...
This chapter also introduces the \traceq library, which automates data collection and visualization, simplifying the profiling workflow.
