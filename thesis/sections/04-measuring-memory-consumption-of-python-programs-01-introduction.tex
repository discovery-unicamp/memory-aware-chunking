...
Section~\ref{sec:mmc-traceq} introduces the \traceq library, designed to allow a memory-footprint free profiling for both Python-internal (\eg, \texttt{tracemalloc}) and system-level metrics (\eg, \texttt{psutil}~\cite{psutil}).
