...
\begin{itemize}
    ...
    \item \textbf{Delayed Cleanup.} Garbage collection triggers are based on internal thresholds, causing potential delays. Consequently, memory profiling may reflect artificially elevated or reduced memory usage depending on timing relative to garbage collection cycles.
\end{itemize}
