...
\begin{itemize}
    ...
    \item \texttt{WORKER\_SCENARIOS}: Specifies worker configurations (e.g., \texttt{single:1}, \texttt{two:2}, \texttt{smalln:4}, \texttt{bign:8}).
...
It iteratively generates data volumes for all combinations of dimensions defined within the configured size range (e.g., $(100,100,100)$ through $(400,400,400)$), saving each as individual \texttt{.segy} files.
