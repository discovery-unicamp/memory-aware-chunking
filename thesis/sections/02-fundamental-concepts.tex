...
\begin{itemize}
    ...
    \item \textbf{Parallel \ac{I/O} and Distribution:} Efficient reading and writing of chunks (inlines or xlines) demands parallel file systems or distributed object stores. Otherwise, \ac{I/O} becomes a bottleneck, overshadowing the benefits of \ac{HPC} parallelism~\cite{Folk2011}.
...
Another key detail is how Python handles freed memory internally:
\begin{quote}
...
\begin{itemize}
    ...
    \item \textbf{Container and Ballooning Interactions:} Container runtimes track memory usage at the cgroup level, which may aggregate \ac{RSS} differently and consider \ac{VMS} in overall memory caps.
\end{itemize}
