...
With these findings, we have a clearer framework for implementing memory-aware chunking strategies for applications that rely on these operators: one can rely on volume-based models (potentially augmented by minimal shape features) and still maintain accurate peak \ac{RAM} consumption estimates, even with relatively small training sets.
