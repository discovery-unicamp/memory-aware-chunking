...
\vspace{1em}
\begin{lstlisting}[style=bashstyle,caption={Excerpts from \texttt{experiment.sh}~\footnote{Experiment Script. Available at \url{https://github.com/discovery-unicamp/memory-aware-chunking/blob/main/experiments/02-predicting-memory-consumption-from-input-shapes/scripts/experiment.sh}. Accessed: 2025-04-29.} that orchestrate Docker-based runs. Variables like \texttt{DATASET\_FINAL\_SIZE} and \texttt{DATASET\_STEP\_SIZE} define shape ranges for dataset generation.}, label={lst:exp_sh}]
#!/usr/bin/env sh
...
\begin{lstlisting}[style=pythonstyle,
    caption={Feature extraction excerpt from \texttt{collect\_results.py}~\footnote{Results. Available at \url{https://github.com/discovery-unicamp/memory-aware-chunking/blob/main/experiments/02-predicting-memory-consumption-from-input-shapes/experiment/collect_results.py}. Accessed: 2025-04-29.}. Additional derived metrics capture polynomial or ratio-based growth.},
