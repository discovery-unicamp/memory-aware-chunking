...
Conversely, simpler, volume-based \EBRPD{attributes}{operators} might benefit from fewer, larger chunk divisions.
...
\EB{A seção não explicou como funciona o autochunking. Seria possível explicar isso de forma simples, talvez com um fluxograma ou um pseudo-código?} 