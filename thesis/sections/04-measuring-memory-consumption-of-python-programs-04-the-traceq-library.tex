...
By integrating Python-internal tools such as \texttt{tracemalloc} with \ac{OS}-level utilities like \texttt{psutil} and Docker or \ac{cgroup} statistics, \traceq provides a unified, reliable profiling \EBRP{experience}{mechanism} suited to complex computational environments.
