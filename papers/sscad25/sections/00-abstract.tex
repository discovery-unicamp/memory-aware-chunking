...
Oversized chunks exhaust worker memory and trigger out-of-memory (OOM) failures that terminate entire jobs, while undersized chunks inflate scheduling overhead, reduce cache locality, and underutilize computational resources.
...
We evaluate our approach through experiments with seismic imaging operators, focusing on the memory-intensive Gradient Structure Tensor (GST3D) computation.
