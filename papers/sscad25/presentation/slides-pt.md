...
```mermaid
graph LR
    A["Grande Conjunto<br/>de Dados<br/>Terabytes"] --> B["Particionar em<br/>Chunks"]
    B --> C1["Worker 1<br/>Processar Chunk"]
    B --> C2["Worker 2<br/>Processar Chunk"]
    B --> C3["Worker 3<br/>Processar Chunk"]
    B --> C4["Worker N<br/>Processar Chunk"]
    C1 --> D["Combinar<br/>Resultados"]
    C2 --> D
    C3 --> D
    C4 --> D
